		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="service-text">
					<p>We fix all kind of computer problems either hardware or software. We upgrade hardware for optimum perfomance of your computer, no need to worry on slow computer we have a solution for such issues.</p>
				</div>
			</div>
		</div>
		<div class="row">
