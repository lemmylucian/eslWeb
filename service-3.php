...
<head>
	...
	<title>Network and Internet</title>
			...
			<div class="col-lg-12">
				<div class="breatcumb-content text-center">
					...
					<div class="breatcumb-content-text">
						<ul>
							<li><a href="#">Home</a> <i class="fas fa-angle-right"></i> <span>Service</span></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="service-text">
					<p>We provide network installation for offices, homes and industries as well as internet services with an affordable price. From Wireless Network to Wired Network such as LAN, WAN and MAN depending on your your business needs.</p>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-12">
				<div class="besoft-sinlge-service-box">
					<div class="besoft-service-thumb">
						<img src="assets/images/resource/blog1.png" alt="">
					</div>
					<div class="besoft-service-content">
						<div class="besoft-service-icon">
							<i class="icon flaticon-laptop"></i>
						</div>
						<div class="besoft-service-title">
							<span>Analysis</span>
							<h4>Secure Data</h4>
						</div>
					</div>
...
<!--==================================================-->
<!-- End besoft service Area -->
<!--==================================================-->
<!-- =================================================-->
<!-- Start of Pricing Area -->
<!-- ================================================ -->
<div class="portfolio_area style-two">
	<div class="container">
		<div class="row">
		...
		<div class="contact-now-form-box">
			<div class="contact-now-form-box-inner">
				...
				<div class="contact-now-title">
					...
					<p>50 Free User Mail accounts</p>
					<p>SSL Protection</p>
				</div>
			</div>
		</div>
	...
	<div class="col-lg-4">
		<div class="contact-now-form-box">
			<div class="contact-now-form-box-inner">
				...
				<div class="contact-now-title">
					<h4>Tanzanite Plan</h4>
					<p>100+ GB of Storage</p>
					<p>50+ Free User Mail accounts</p>
					<p>SSL Protection</p>
					<p>10Gbps Data Speed</p>
				</div>
			</div>
		</div>
	</div>
