			...
			<div class="col-lg-12">
				<div class="breatcumb-content text-center">
					...
					<div class="breatcumb-content-text">
						<ul>
							<li><a href="index.php">Home</a> <i class="fas fa-angle-right"></i> <span>Service</span></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="row align-items-center">
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="service-text">
					<p>We are selling desktop, laptop and their accessories, CCTV camera, access controls, PBX systems, solar systems as well as softwares such as security, productivity, designing and firewalls.</p>
				</div>
			</div>
		</div>
		<div class="row">
